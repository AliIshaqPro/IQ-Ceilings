...
const WhatsAppButton = () => {
  ...
  const phoneNumber = "923335170817"; // Replace with actual number
      ...
      {isVisible && (
        ...
        >
          <div className="relative">
            <div className="absolute inset-0 bg-[#25D366] rounded-full blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-300" />
